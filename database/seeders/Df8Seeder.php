...
class Df8Seeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $komponen=DesignFaktorKomponen::join('design_faktor as df','df.id','=','design_faktor_id')->select(DB::raw('design_faktor_komponen.*'))->where('df.kode','DF8')->orderBy('urutan','ASC')->get();
